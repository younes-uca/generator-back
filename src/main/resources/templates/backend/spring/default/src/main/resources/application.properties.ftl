...
spring.datasource.url=jdbc:mysql://localhost/${config.backend.databaseName}?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC
